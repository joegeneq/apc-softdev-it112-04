...
class StocksRecordController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['StocksRecord']))
		{
			$model->attributes=$_POST['StocksRecord'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('StocksRecord');
	...
	{
		$model=new StocksRecord('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StocksRecord']))
			$model->attributes=$_GET['StocksRecord'];
	...
	{
		$model=StocksRecord::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param StocksRecord $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='stocks-record-form')
		{
