...
class StockIssueItemController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['StockIssueItem']))
		{
			$model->attributes=$_POST['StockIssueItem'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('StockIssueItem');
	...
	{
		$model=new StockIssueItem('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StockIssueItem']))
			$model->attributes=$_GET['StockIssueItem'];
	...
	{
		$model=StockIssueItem::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param StockIssueItem $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='stock-issue-item-form')
		{
