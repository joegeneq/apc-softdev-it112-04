...
class PaymentRecordController extends Controller
{
	...
	{
		$model=new PaymentRecord('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PaymentRecord']))
			$model->attributes=$_GET['PaymentRecord'];
	 ...
	 * @param PaymentRecord $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='payment-record-form')
		{
