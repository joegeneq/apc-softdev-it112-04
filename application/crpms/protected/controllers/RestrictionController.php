...
class RestrictionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Restriction'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Restriction');
	...
	{
		$model=new Restriction('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Restriction']))
			$model->attributes=$_GET['Restriction'];
	...
	{
		$model=Restriction::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='restriction-form')
		{
