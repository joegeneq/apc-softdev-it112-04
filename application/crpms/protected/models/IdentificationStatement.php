...
/**
 * This is the model class for table "identification_statement".
 *
 * The followings are the available columns in table 'identification_statement':
 * @property integer $id
 * @property string $date_of_entry
 * @property string $reference_code
 * @property string $location_code
 * @property integer $shelf_number
 * @property integer $bay_number
 * @property integer $box_number
 * @property integer $folder_number
 ...
 */
class IdentificationStatement extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return IdentificationStatement the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('shelf_number, bay_number, box_number, folder_number, accession_number', 'numerical', 'integerOnly'=>true),
			array('reference_code, material_type, title, document_date, fonds, sub_fonds, sub_sub_fonds, record_series, sub_series, file, item, record_medium', 'length', 'max'=>100),
	...
	public function relations()
	{
		...
		return array(
			'recordsDocuments' => array(self::HAS_MANY, 'RecordsDocuments', 'identification_statement_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('bay_number',$this->bay_number);
		$criteria->compare('box_number',$this->box_number);
		$criteria->compare('folder_number',$this->folder_number);
