...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2015 at 07:49 PM
...
ALTER TABLE `return_slip_form`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `patient_name_UNIQUE` (`patient_name`), ADD KEY `fk_return_slip_form_account1_idx` (`account_id`);
